...
/*
	1. 값의 저장을 위한 변수
		...
		4) 변수명 규칙
			...
			변수 이름은 알파벳(대소문자 모두 가능), 숫자, 언더바(_)로만 구성       _로 시작은 가능하다
...
int main2_1() {
	...
	int number1 = 10;
	int number2 = 5;
	printf("%d %d\n", number1);  // 쓰레기값이 두번째 %d에 저장 오류는 뜨지 않는다
	printf("%d %d\n", number1,number2);
	//두변수 한번에 선언
	int number3, number4, number5 = 10;// number3,4는 이때 쓰레기값을 가진다 int number3=4, number4=5, 이런식이면 변수초기화 된것
	//초기화
	number3 = 3;
	number4 = 4;
